          ...
          <form onSubmit={handleRegister} className="px-10 pb-10 space-y-5">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-4 text-gray-400 font-bold tracking-widest">Or join with</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-white border border-gray-100 hover:border-gray-200 text-gray-700 rounded-2xl font-bold text-sm transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-3 active:scale-[0.98]"
            >
              {isGoogleLoading ? (
                <Loader2 className="animate-spin" size={18} />
              ) : (
